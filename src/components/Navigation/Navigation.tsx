    ...
    <header className={`glass ${styles.nav}`}>
      <div className={`container ${styles.inner}`}>
        <Link to="/" className={styles.logo}>
          ...
          <span className={styles.logoText}>Burger<em>Lovers</em></span>
        </Link>
      ...
      {menuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <NavLink to="/reviews" className={navLinkClass} onClick={() => setMenuOpen(false)}>Reviews</NavLink>
          <NavLink to="/restaurants" className={navLinkClass} onClick={() => setMenuOpen(false)}>Restaurants</NavLink>
          {user && (
